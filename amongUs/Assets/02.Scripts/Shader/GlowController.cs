...
{
    public static GlowController _instance;

    public CommandBuffer _commandBuffer;

    public List<GlowObjectCmd> _glowableObjects = new List<GlowObjectCmd>();
    public Material _glowMat;
    public Material _blurMaterial;
    public Vector2 _blurTexelSize;

    public int _prePassRenderTexID;
    public int _blurPassRenderTexID;
    public int _tempRenderTexID;
    public int _blurSizeID;
    public int _glowColorID;
